...
class User extends Model implements RoleableInterface, PermissibleInterface, PersistableInterface, UserInterface
{
    ...
    public function channelDailyTrackers()
    {
        return $this->hasMany('App\Models\ChannelDailyTracker');
    }

    public function videoDailyTrackers()
    {
        return $this->hasMany('App\Models\VideoDailyTracker');
    }
    ...
    //          $user->videos()->delete();
    //          $user->channelDailyTrackers()->delete();
    //          $user->videoDailyTrackers()->delete();
